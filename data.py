...
" Now I'm not done yet. If you want to see my progress you can do it here: github.com/kipariz/LIZA",]
    ],
...
[
	...
	[
        ...
        ["I'm look like most of other computer program. The main part of me look like this:\nimport tkinter as tk\nimport requests\nfrom nltk.chat.util import Chat, reflections"]
],
    [
...
[
    ...
    [
        ...
        ["For now I understand only English. I hope later I'll learn much more, I`m still young now :) "]
],
